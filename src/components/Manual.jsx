 ...
 * Displays the complete formatted user manual in tabs.
 * @param {function} onBack - Callback to return to Home view
 */
export default function Manual({ onBack }) {
  const [activeTab, setActiveTab] = useState('strategy'); // 'strategy' | 'top100' | 'words200' | 'words600' | 'pillars'
    ...
    <div className="card" style={{ animationDelay: '0.1s', display: 'flex', flexDirection: 'column', maxHeight: '85vh', overflow: 'hidden' }}>
      ...
      <div style={{ 
        ...
        <button 
          ...
          className={`direction-tab ${activeTab === 'strategy' ? 'active' : ''}`}
          style={{ flex: 'none', padding: '0.5rem 0.85rem', fontSize: '0.8rem' }}
        >
          Strategy & Grammar
        </button>
        <button 
          onClick={() => handleTabChange('top100')} 
          className={`direction-tab ${activeTab === 'top100' ? 'active' : ''}`}
          style={{ flex: 'none', padding: '0.5rem 0.85rem', fontSize: '0.8rem' }}
        >
          Top 100 Words
        </button>
        <button 
          onClick={() => handleTabChange('words200')} 
          className={`direction-tab ${activeTab === 'words200' ? 'active' : ''}`}
          style={{ flex: 'none', padding: '0.5rem 0.85rem', fontSize: '0.8rem' }}
        >
          Words 101-200
        </button>
        <button 
          onClick={() => handleTabChange('words600')} 
          className={`direction-tab ${activeTab === 'words600' ? 'active' : ''}`}
          style={{ flex: 'none', padding: '0.5rem 0.85rem', fontSize: '0.8rem' }}
        >
          Words 201-600
        </button>
        <button 
          ...
          className={`direction-tab ${activeTab === 'pillars' ? 'active' : ''}`}
          style={{ flex: 'none', padding: '0.5rem 0.85rem', fontSize: '0.8rem' }}
        >
          Structural Pillars
        </button>
      ...
      >
        ...
        {activeTab === 'strategy' && (
          <div style={{ animation: 'fadeIn 0.3s forwards' }}>
            ...
            <table className="manual-table" style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '1.5rem' }}>
              <thead>
                <tr style={{ borderBottom: '2px solid var(--primary)' }}>
                  <th style={{ padding: '0.5rem', textAlign: 'left' }}>Rank / Rang</th>
                  <th style={{ padding: '0.5rem', textAlign: 'left' }}>Words Known / Mots</th>
                  <th style={{ padding: '0.5rem', textAlign: 'left' }}>Coverage / Couverture</th>
                </tr>
              </thead>
              <tbody>
                <tr style={{ borderBottom: '1px solid var(--border-element)' }}>
                  ...
                  <td style={{ padding: '0.5rem' }}>100</td>
                  <td style={{ padding: '0.5rem' }}>~50% of basic conversation</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--border-element)' }}>
                  <td style={{ padding: '0.5rem' }}>600</td>
                  <td style={{ padding: '0.5rem' }}>600</td>
                  <td style={{ padding: '0.5rem' }}>~70% of daily conversation</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--border-element)' }}>
                  <td style={{ padding: '0.5rem' }}>1000</td>
                  <td style={{ padding: '0.5rem' }}>1000</td>
                  <td style={{ padding: '0.5rem' }}>~85% of daily conversation</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--border-element)' }}>
                  <td style={{ padding: '0.5rem' }}>3000</td>
                  <td style={{ padding: '0.5rem' }}>3000</td>
                  <td style={{ padding: '0.5rem' }}>~95% of daily communication</td>
                </tr>
                <tr style={{ borderBottom: '1px solid var(--border-element)' }}>
                  <td style={{ padding: '0.5rem' }}>6000+</td>
                  <td style={{ padding: '0.5rem' }}>6000+</td>
                  <td style={{ padding: '0.5rem' }}>~99%+ (news, novels, fluency)</td>
                </tr>
              </tbody>
            </table>
          ...
          <div style={{ animation: 'fadeIn 0.3s forwards' }}>
            ...
            <table className="manual-table">
              ...
              <tbody>
                ...
                <tr><td>femme</td><td>woman</td><td>La femme travaille. (The woman works.)</td></tr>
            ...
            <table className="manual-table">
              ...
              <tbody>
                ...
                <tr><td>sur</td><td>on</td><td>Le livre est sur la table. (The book is on the table.)</td></tr>
                <tr><td>sous</td><td>under</td><td>Le chat est sous la table. (The cat is under the table.)</td></tr>
        ...
        {activeTab === 'words200' && (
          <div style={{ animation: 'fadeIn 0.3s forwards' }}>
            <h4 style={{ color: 'var(--primary)', fontWeight: '800' }}>1. Action & Thought Verbs / Verbes d'action et pensée (25 words)</h4>
            <table className="manual-table">
              <thead>
                <tr>
                  <th>French</th>
            ...
            <h4 style={{ color: 'var(--primary)', fontWeight: '800', marginTop: '1.5rem' }}>4. Adverbs & Question Words (25 words)</h4>
            <table className="manual-table">
              <thead>
                <tr>
                  <th>French</th>
        ...
        {activeTab === 'words600' && (
          <div style={{ animation: 'fadeIn 0.3s forwards' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', maxHeight: '180px', overflowY: 'auto', border: '1px solid var(--border-element)', padding: '0.5rem', borderRadius: '8px', background: 'var(--bg-input)', marginBottom: '1.5rem' }}>
            ...
            <h4 style={{ color: 'var(--primary)', fontWeight: '800', marginTop: '1rem' }}>2. People, Body & Abstract Nouns / Noms abstraits, personnes & corps (301-400)</h4>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', maxHeight: '180px', overflowY: 'auto', border: '1px solid var(--border-element)', padding: '0.5rem', borderRadius: '8px', background: 'var(--bg-input)', marginBottom: '1.5rem' }}>
            ...
            <h4 style={{ color: 'var(--primary)', fontWeight: '800', marginTop: '1rem' }}>3. Places, Objects & Food / Lieux, objets & nourriture (401-500)</h4>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', maxHeight: '180px', overflowY: 'auto', border: '1px solid var(--border-element)', padding: '0.5rem', borderRadius: '8px', background: 'var(--bg-input)', marginBottom: '1.5rem' }}>
            ...
            <h4 style={{ color: 'var(--primary)', fontWeight: '800', marginTop: '1rem' }}>4. Adjectives, Adverbs & Connectors (501-600)</h4>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', maxHeight: '180px', overflowY: 'auto', border: '1px solid var(--border-element)', padding: '0.5rem', borderRadius: '8px', background: 'var(--bg-input)' }}>
        ...
        {/* TAB 5: STRUCTURAL PILLARS */}
        {activeTab === 'pillars' && (
          <div style={{ animation: 'fadeIn 0.3s forwards' }}>
            <p style={{ color: 'var(--text-muted)', marginBottom: '1rem', fontStyle: 'italic' }}>
              Master these core priority structural words to rapidly boost your comprehension of connected sentences.
            </p>
            ...
            <table className="manual-table">
              ...
              <tbody>
                ...
                <tr><td>ces</td><td>these/those</td><td>Ces enfants jouent. (These children are playing.)</td></tr>
